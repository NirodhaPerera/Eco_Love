        ...
        <div className="w-full md:w-1/2 relative h-48 sm:h-64 md:h-auto shrink-0">
          ...
          <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 text-white">
            <div className="flex items-center gap-2 mb-1 md:mb-2">
              <Sparkles className="text-yellow-400 fill-yellow-400" size={14} />
              <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.3em]">Year-Round Destination</span>
            </div>
            <p className="text-2xl md:text-3xl font-serif italic leading-tight">Sri Lanka <br className="hidden md:block" /> is always in season.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center space-y-6 md:space-y-8 bg-white">
          <header className="space-y-3 md:space-y-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-[9px] md:text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">365 Days of Adventure</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-serif italic text-slate-900 leading-tight">
              Explore freely, <br className="hidden md:block" /> anytime you visit.
            </h2>
          </header>

          <p className="text-slate-500 text-xs md:text-sm leading-relaxed font-light">
            With diverse microclimates across the island, every month offers sunshine, scenic beauty, and authentic cultural experiences in every corner of Sri Lanka.
          </p>
